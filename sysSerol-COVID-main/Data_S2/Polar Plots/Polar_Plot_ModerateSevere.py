...
df = df.loc[df['group'].isin(['Moderate', 'Severe']), :]
...
#############################################################
# Polar Plots / Flower Plots / Rose Nightingale Plots
#############################################################
signif_idx = 0
for i in range(0, 3, 1):
    ...
    sns.set_style("darkgrid",
                  {'axes.linewidth': 2, 'axes.edgecolor': 'black', 'xtick.bottom': True, 'xtick.top': False,
                   'ytick.left': True, 'ytick.right': False, 'font.sans-serif': 'Arial'})
